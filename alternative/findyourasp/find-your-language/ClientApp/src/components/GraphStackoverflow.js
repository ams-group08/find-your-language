        ...
        return <div>
            <div className="row justify-content-left">
                <div className="col-10">
                    ...
                    <ul>
                        <li>Votes: it is possible to vote questions or posts. Users gain or lose reputation based on the quality of their interactions with the system and other community members. This aims people to focus on questions about an actual problem they are facing. They should include details about what they have tried and exactly what they are trying to do. It’s really important to avoid questions that are primarily opinion-based, or that are likely to generate discussion rather than answers.</li>
                        <li>Answers: the system keeps track of the number of answers associated with the question. Answers could also be voted. Good answers are voted up and rise to the top. The best answers show up first so that they are always easy to find</li>
                        <li>Views: it counts the number of times someone followed the site to read the question. This could be because this person is willing to answer it or he/she is just consulting its answer.</li>
                    </ul>
